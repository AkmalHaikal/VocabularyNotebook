...
password = 'akmal392'
cxn_str = f'mongodb+srv://AkmDB:{password}@cluster0.knrmbyg.mongodb.net/?retryWrites=true&w=majority'
...
def msg():
    ...
    return render_template('msg.html', word=word, suggestions=suggestions)
